...
class ArrumacaoAutomatica:
    ...
    def realiza_procura(self, mecanismo_procura):
        ...
        operadores = [ArrumacaoOperador(Acao.AVANÇAR_ESTE, 1.0, self.agir),
                      ...
                      ArrumacaoOperador(Acao.AVANÇAR_NORDESTE, math.sqrt(2), self.agir),
                      ArrumacaoOperador(Acao.AVANÇAR_NOROESTE, math.sqrt(2), self.agir),
                      ArrumacaoOperador(Acao.AVANÇAR_SUDESTE, math.sqrt(2), self.agir),
                      ArrumacaoOperador(Acao.AVANÇAR_SUDOESTE, math.sqrt(2), self.agir),
            ]
